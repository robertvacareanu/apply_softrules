...
def word_averager(config: Config):
    ...
    for threshold in config.get('thresholds'):
        ...
        print('f1: ', f1_score(gold, pred, average="micro", labels=list(set(gold).difference(['no_relation']))))
        print('precision: ', precision_score(gold, pred, average="micro", labels=list(set(gold).difference(['no_relation']))))
        print('recall: ', recall_score(gold, pred, average="micro", labels=list(set(gold).difference(['no_relation']))))
        print('---------------------------------------')
        print("macro")
        print('f1: ', scores[4])
